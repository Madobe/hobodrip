        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div v-for=" ( account, i ) in sets " :class="[
                        ...
                        <div class="form-floating">
                            <input type=" text" class="form-control" :id="`account-name-input-${i}`"
                                ...
                                " />
                            <label :for="`account-name-input-${i}`">Set {{ i + 1 }}</label>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" @click="$emit( 'removeSet' )">
                        Remove last set
                    </button>
                    <button type="button" class="btn btn-light" @click="$emit( 'addSet' )">
                        Add new set
                    </button>
                </div>
            </div>
